...
export const ROUTE_PRESETS = [
  ...
  },
  {
    ...
    startName: 'Newport (Brenton Reef Light)',
    start: { lat: 41.40, lon: -71.35 },
    destName: "Bermuda (St. David's)",
    dest: { lat: 32.40, lon: -64.55 },
  },
  {
    name: 'Cowes to Fastnet Rock (Rolex Fastnet Race)',
    startName: 'Cowes (Solent Fairway)',
    start: { lat: 50.65, lon: -1.35 },
  ...
  },
  {
    ...
    startName: 'San Francisco (Golden Gate Approach)',
    start: { lat: 37.80, lon: -122.52 },
